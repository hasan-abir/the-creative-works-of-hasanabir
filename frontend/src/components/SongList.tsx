  ...
  return (
    <CardList heading="Music">
      {songs.map((song) => {
        return (
          <Card key={song.id}>
            <div className="p-5 border border-gray-500 w-[385px] rounded-[16px] h-[250px]">
              <CTABtn extraClasses="w-[100px] h-[100px] flex justify-center items-center rounded-[20px]">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 32 32"
